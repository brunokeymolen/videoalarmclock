 ...
 *
 * NN20Clock change: takes an already-created i2c_master bus rather than
 * a port number, because the codec shares its bus with the GT911 touch
 * controller and only one owner may create it. See VENDORED.md.
 *
 * @param[in] bus      I2C master bus the codec sits on, borrowed
